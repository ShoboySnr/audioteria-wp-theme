...
const categorySlider = () => {
    ...
    let categoryAll = document.querySelectorAll('.category');

    for (var index in categoryAll) {
        if (categoryAll.hasOwnProperty(index)) {

            let category = categoryAll[index].getAttribute('data-title');
